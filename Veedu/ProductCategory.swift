...
struct ProductCategory {
    ...
    static let livingRoomProdCategories: [ProductCategory] = [
        ...
        ProductCategory(productCategoryName: "Textiles", productCategoryImage: "LivingTextiles"),
        ProductCategory(productCategoryName: "Accessories", productCategoryImage: "LivingAccessories")
    ...
    static let bedroomProdCategories: [ProductCategory] = [
        ...
        ProductCategory(productCategoryName: "Textiles", productCategoryImage: "BedTextiles"),
